...
const DEFAULT_SETTINGS = {
    ...
    STATUS_REACT_EMOJI: "true",  // status reaction content: "" = random from STATUS_LIKE_EMOJIS, "name" = react with sender's WhatsApp display name, anything else = used literally as the reaction text
